<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employer_list.aspx.cs" Inherits="employer_list" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Employee Management | Employer list:: w3layouts</title>
                    ...
                    <div class="col-lg-8 job_info_left">
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="employer_single.aspx">Comapany Name</a></h4>
                                    <h5 class="mt-2">Sales & Marketing</h5>
                                    <p><i class="fas fa-map-marker-alt"></i> Istanbul / Turkey</p>
                                    <ul class="links_bottom_emp mt-2">
                                        <li><a href="employer_single.aspx"><i class="far fa-envelope"></i> <span class="icon_text"> Email this Job</span></a></li>
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="employer_single.aspx">
                                            Comapany Name</a></h4>
                                    <h5 class="mt-2">Arts, Design, and Media, Web Developer</h5>
                                    <p><i class="fas fa-map-marker-alt"></i> Istanbul / Turkey</p>
                                    <ul class="links_bottom_emp mt-2">
