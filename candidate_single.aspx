<%@ Page Language="C#" AutoEventWireup="true" CodeFile="candidate_single.aspx.cs" Inherits="candidate_single" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Employee Management | Candidates list:: w3layouts</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8">
    <meta name="keywords" content="Employee a Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="logo">
                            <h1>
                                <a class="navbar-brand" href="index.aspx">
                                    <i class="fab fa-codepen"></i> Employee</a>
                            </h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-lg-auto text-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="how.aspx">How it works</a>
                                </li>
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="services.aspx">Candidates</a>
                                        <a class="dropdown-item" href="candidates_list.aspx" title="">Candidates List 1</a>
                                        <a class="dropdown-item" href="candidates_list.aspx" title="">Candidates List 2</a>
                                        <a class="dropdown-item" href="candidates_list.aspx" title="">Candidates List 3</a>
                                        <a class="dropdown-item" href="candidates_single.aspx" title="">Candidates Single 1</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="employer_list.aspx"> Employer List 1</a>
                                        <a class="dropdown-item" href="employer_list.aspx">Employer List 2</a>
                                        <a class="dropdown-item" href="employer_list.aspx">Employer List 3</a>
                                        <a class="dropdown-item" href="employer_list.aspx">Employer List 4</a>
                                        <a class="dropdown-item" href="employer_single.aspx">Employer Single 1</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-8 job_info_left">
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="candidates_single.aspx">Richard Thomas</a></h4>
                                    ...
                                    <ul class="links_bottom_emp mt-2">
                                        <li><a href="candidates_single.aspx"><i class="far fa-envelope"></i> <span class="icon_text"> Email this Job</span></a></li>
                            ...
                            <div class="col-md-3 emp_btn text-right">
                                <a href="candidates_single.aspx">Shortlist </a>
                            </div>
                        </div>
                        <!--// Emply List -->
                        <!--/ Emply List1 -->
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="candidates_single.aspx">Tammy Dixon</a></h4>
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="candidates_single.aspx">
                                                Asron Bailey</a></h4>
    ...
    <footer class="footer-emp-w3layouts bg-dark dotts py-lg-5 py-3">
        <div class="container-fluid px-lg-5 px-3">
            <div class="row footer-top">
                ...
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="404.aspx">Error</a>
                        </li>
                        <li>
                            <a href="pricing.aspx">Job Packages</a>
                        </li>
                        <li>
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="employer_list.aspx">For Employers</a>
                        </li>
                    </ul>
            ...
            <div class="copyright mt-4">
                <p class="copy-right text-center ">&copy; 2018 Employee. All Rights Reserved | Design by
