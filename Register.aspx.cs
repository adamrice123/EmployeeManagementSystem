        ...
        if (contenttype != String.Empty)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                else
                {
                    ...
                    string strQuery = "insert into EmployeeTable(EmployeeId,EmployeeName,Mail,MobileNo,Address,DateOfJoin,Department,Division,DateOfBirth,Password,UserType,Gender,EmployeeImage," +
                        "ContentType,CreatedBy,CreatedOn) values (@EmployeeId,@EmployeeName,@Mail,@MobileNo,@Address,@DateOfJoin,@Department,@Division,@DateOfBirth,@Password,@UserType,@Gender," +
                        "@EmployeeImage,@ContentType,@CreatedBy,@CreatedOn)";
                    ...
                    Clear();
                    string message = "Congratulations! You have Registered Succesfully!";
                    System.Text.StringBuilder sb = new System.Text.StringBuilder();
                    sb.Append("<script type = 'text/javascript'>");
                    sb.Append("window.onload=function(){");
                    sb.Append("alert('");
