<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_User" EnableEventValidation="false" ValidateRequest="false"%>
                    ...
                    <div class="panel-content p-0">
                            <div class="panel-content">
                                ...
                                <asp:RadioButton ID="rbFemale" Text="Female" runat="server" GroupName="Gender" CssClass="form-control" />
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label" for="validationDefault05">User Image</label>
